...
def _get_file(search_keywords, testing, extract_extire_database):
    ...
    if testing:
        ...
        if extract_extire_database:
            ...
            p = "/Users/chris/DocumentLocal/workspace/hfm/scripts_in_progress/xml_parser/xml_files/error_parsed_updated_05_xmlerror.csv"
            data = pd.read_csv(p)
...
if __name__ == "__main__":
    ...
    save_at = "/Users/chris/DocumentLocal/workspace/hfm/scripts_in_progress/xml_parser/xml_files/error_parsed_updated_08_db_xml_link_error.csv"
